<template>
  <div>
    <p class="font-weight-black" style="cursor: pointer" @click="ocultar()">CLIENTES<v-icon
...
<script>
  ...
  export default {
    data: () => ({
      ...
      datos:[],
      headers: [
      { text: 'RAZÓN SOCIAL', value: 'nombre', align: 'center', },
