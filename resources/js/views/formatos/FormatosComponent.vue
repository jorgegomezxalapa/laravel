<template>
    <v-container fluid>
      ...
      >
    <v-card-title class="font-weight-black">MÓDULO DE FORMATOS<v-chip
      class="ma-2"
      color="secondary"
      dark
    ...
    data () {
      return {
        ...
        { text: 'FECHA DE REGISTRO', align: 'center', value: 'created_at',class: "primary" },
          ...
          { text: 'RAZÓN SOCIAL', align: 'center', value: 'userName',class: "primary" },
          { text: 'DESCRIPCIÓN', align: 'center', value: 'rol',class: "primary" },
...
localLocale.locale(false);
      return localLocale.format('LL')
        ...
        nuevoEmpleado(){
            this.$router.push({ name: 'nuevoFormato' }).catch(()=>{});
        },
