<template>
  ...
  >
   <form @submit.prevent="submit">
    <v-card-title class="font-weight-black">INFORMACIÓN DEL FORMATO</v-card-title>
...
<v-row>
       <v-col
        cols="12"
      >
     <p class="font-weight-black">FORMULARIO DE FORMATO, LOS CAMPOS MARCADOS CON UN ASTERISCTO (*) SON REQUERIDOS PARA CONTINUAR.</p>
    </v-col>
    </v-row>
  <v-card-text>
    <v-container>
