    ...
    data () {
      return {
        ...
        headersSolicitadas: [
          ...
          { text: 'TIPO DE SOLICITUD', align: 'center', value: 'solicitud.urgente' },
         { text: 'FECHA DE SOLICITUD', align: 'center', value: 'solicitud.fecha' },
          { text: 'CLIENTE', align: 'center', value: 'solicitud.cliente.razonSocial' },
          { text: 'PERSONA SOLICITANTE', align: 'center', value: 'solicitud.solicitante.nombre' },
          { text: 'AGENTE DE VENTAS', align: 'center', value: 'solicitud.agente.name' },
